...
// the route works in insomnia
// the logic is subtracting appropriately from existing numbers but info not being sent in PUT
// some sort of syntax error, seens to be to do with not recognising info as JSON?! (when googled)
